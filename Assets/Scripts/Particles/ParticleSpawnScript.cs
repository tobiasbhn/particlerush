...
public class ParticleSpawnScript : MonoBehaviour {
    ...
    private void SpawnParticle() {
        ...
        RuntimeDataManager.setValue.particlesSpawned++;
    }
    ...
    private ParticleType DefineType() {
        switch (spawnModi) {
            ...
            case SpawnModi.onlyNorm:
                RuntimeDataManager.setValue.normalParticlesSpawned++;
                return ParticleType.grow;
            case SpawnModi.onlyShrink:
                RuntimeDataManager.setValue.shrinkParticlesSpawned++;
                return ParticleType.shrink;
            case SpawnModi.onlyGold:
                RuntimeDataManager.setValue.goldParticlesSpawned++;
